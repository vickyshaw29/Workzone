...
function Popover() {
  ...
  return (
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog className="relative z-10" as="form" onClose={closePopover}>
           <Transition.Child
            as={Fragment}
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          ...
          >
            <Dialog.Panel className="w-full  max-w-md transform overflow-hidden rounded 2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
              ...
              <div className='mt-2'>
                <input placeholder='Enter a task...' value={taskInput} onChange={(e)=>setTaskInput(e?.target?.value)} className='w-full border border-gray-300 rounded-md outline-none p-5'/>
              </div>
            </Dialog.Panel>
          </Transition.Child>
          </div>
